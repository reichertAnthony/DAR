...
public class TodoEndPoint {
    ...
    @ApiMethod(name = "listbyTitle", httpMethod = ApiMethod.HttpMethod.GET, path="listbyTitle")
    public Todo getTodosbyTitle(@Named("titre") String titre) {
        return TodoRepository.getInstance().findTodosbyTitle(titre);
    }
